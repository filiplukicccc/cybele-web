  ...
  render() {
    return (
        <div className={css.services}>
          <Parallax bgImage={idea} strength={500} blur={{ min: -1, max: 3 }}>
            <div style={{ background: 'rgba(2,13,25,0.89)', padding: '100px 0 50px 0' }}>
              <TrackVisibility once throttleInterval={100}>
                {
                  ({ isVisible }) => isVisible ?
                    <StyleRoot>
                      <div style={styles.tada}>
                        <h2>O U R &nbsp;&nbsp; <span style={{ color: '#003571' }}>S E R V I C E S</span></h2>
