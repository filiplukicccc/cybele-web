    ...
    return (
      <div className={css.aboutUs}>
        ...
        <div className={css.buttons}>
          <span onClick={this.minus}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle left' /></span>
          <span onClick={this.plus}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle right' /></span>
        ...
        <div className={css.buttons1}>
          <span onClick={this.minus}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle left' /></span>
          <span onClick={this.plus1}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle right' /></span>
          {/* <span style={{width:'20px',height:'8px',backgroundColor:'#f0d389',borderRadius:'3px',marginRight:'10px',cursor:'pointer'}} onClick={this.minus}></span>
        ...
        <div className={css.buttons2}>
          <span onClick={this.minus}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle left' /></span>
          <span onClick={this.plus2}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle right' /></span>
          {/* <span style={{width:'20px',height:'8px',backgroundColor:'#f0d389',borderRadius:'3px',marginRight:'10px',cursor:'pointer'}} onClick={this.minus}></span>
        ...
        <div className={css.buttons3}>
          <span onClick={this.minus}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle left' /></span>
          <span onClick={this.plus3}><Icon className={css.iconGrey + ' ' + css.icon1} size='big' name='angle right' /></span>
          {/* <span style={{width:'20px',height:'8px',backgroundColor:'#f0d389',borderRadius:'3px',marginRight:'10px',cursor:'pointer'}} onClick={this.minus}></span>
